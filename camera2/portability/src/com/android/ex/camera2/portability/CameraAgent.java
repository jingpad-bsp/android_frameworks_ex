...
//    }
    ...
    public static final int BACK_WT_FUSION_ID = 48;
    public static final int SPRD_FRONT_PORTRAIT_ID = 42;


    public static final int SPRD_BACK_PORTRAIT_BACKGROUND_REPLACEMENT_ID = 53;
    public static final int SPRD_FRONT_PORTRAIT_BACKGROUND_REPLACEMENT_ID  = 52;
    ...
    public static interface CameraLightPortraitCallback{
        default public void onLightPortraitStatusChange(int status){}
    }
    ...
    public abstract static class CameraProxy extends SprdCameraProxy {
        ...
        /**
         * Sets the light portrait listener.
         *
         * @param handler  The handler in which the callback will be invoked.
         * @param callback The callback for light portrait results.
         */
        public abstract void setLightPortraitCallback(Handler handler,
                                                      CameraLightPortraitCallback callback);
