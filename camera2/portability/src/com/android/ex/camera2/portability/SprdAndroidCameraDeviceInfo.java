...
public abstract class SprdAndroidCameraDeviceInfo implements CameraDeviceInfo {
    ...
    public int getTruthCameraId(int cameraId) {
	    ...
	    cameraId = Camera.CameraInfo.CAMERA_FACING_BACK;
            ...
            cameraId = Camera.CameraInfo.CAMERA_FACING_BACK;
        } else if(SPRD_FRONT_PORTRAIT_ID == cameraId){
            cameraId = Camera.CameraInfo.CAMERA_FACING_FRONT;
            ...
            cameraId = Camera.CameraInfo.CAMERA_FACING_BACK;
        } else if (BACK_WT_FUSION_ID == cameraId) {
            cameraId = Camera.CameraInfo.CAMERA_FACING_BACK;
        } else if (SPRD_BACK_PORTRAIT_BACKGROUND_REPLACEMENT_ID == cameraId){
            cameraId = Camera.CameraInfo.CAMERA_FACING_BACK;
        } else if (SPRD_FRONT_PORTRAIT_BACKGROUND_REPLACEMENT_ID == cameraId){
            cameraId = Camera.CameraInfo.CAMERA_FACING_FRONT;
        }
        /* @} */
        return cameraId;
