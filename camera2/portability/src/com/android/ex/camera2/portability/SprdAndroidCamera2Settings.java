...
public class SprdAndroidCamera2Settings extends AndroidCamera2Settings {
    ...
    public Camera2RequestSettingsSet getRequestSettings() {
        ...
        if (mCurrentPortraitBackgroundReplacementType != -1) {
            Log.i(TAG, " set CONTROL_SPRD_PORTRAITBACKGROUNDREPLACEMENT_TYPE: mCurrentPortraitBackgroundReplacementType = " + mCurrentPortraitBackgroundReplacementType);
            requestSettings.set(CONTROL_SPRD_PORTRAITBACKGROUNDREPLACEMENT_TYPE, mCurrentPortraitBackgroundReplacementType);
        }
        ...
        if(mSuperMacroPhotoEnable != -1){
            Log.e(TAG, " set ANDROID_SPRD_SUPER_MACROPHOTO_ENABLE: mSuperMacroPhotoEnable = "
                    + mSuperMacroPhotoEnable);
            requestSettings.set(ANDROID_SPRD_SUPER_MACROPHOTO_ENABLE, mSuperMacroPhotoEnable);
        }
        ...
        if(mLightPortraitType != -1){
            requestSettings.set(ANDROID_SPRD_LIGHT_PORTRAIT_TYPE, mLightPortraitType);
            Log.i(TAG,"set ANDROID_SPRD_LIGHT_PORTRAIT_TYPE mLightPortraitType = " + mLightPortraitType);
        }
