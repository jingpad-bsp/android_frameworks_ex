...
//    <integer name="camera_mode_3dnr_video">21</integer>
    ...
    protected int mCurrentPortraitBackgroundReplacementType = -1;
    ...
    protected int mLightPortraitType = -1;
    ...
    protected SprdCameraSettings(SprdCameraSettings src) {
        ...
        mCurrentPortraitBackgroundReplacementType = src.mCurrentPortraitBackgroundReplacementType;
        ...
        mLightPortraitType = src.mLightPortraitType;
    ...
    public void setPortraitBackgroundReplacementType(int type) {
        mCurrentPortraitBackgroundReplacementType = type;
    }
    public int getPortraitBackgroundReplacementType() {
        return mCurrentPortraitBackgroundReplacementType;
    }
    ...
    public void setRefocusEnable(int portraitOptEnable) {
        mPortraitOptEnable = portraitOptEnable;
    }

    public int getRefocusEnable() {return mPortraitOptEnable;}
    ...
    public void setLightPortraitType(int type){
        mLightPortraitType = type;
    }

    public int getLightPortraitType(){
        return mLightPortraitType;
    }

    public int mSuperMacroPhotoEnable = -1;

    public void setSuperMacroPhotoEnable(int enable) {
        Log.e(TAG,"setSuperMacroPhotoEnable enable = " + enable);
        mSuperMacroPhotoEnable = enable;
    }

    public int getSuperMacroPhotoEnable(){
        return mSuperMacroPhotoEnable;
    }
